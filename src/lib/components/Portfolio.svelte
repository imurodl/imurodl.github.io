        ...
        {#each projects as project, index}
          ...
          >
            ...
            <CardContent class="p-4 md:p-6">
              <h3
                class="text-lg md:text-xl font-semibold mb-2 md:mb-3 group-hover:text-primary transition-colors"
              >
                {project.title}
              </h3>

              <p
                class="text-muted-foreground mb-3 md:mb-4 leading-relaxed text-sm md:text-base"
              >
                {project.description}
              </p>
              ...
              {#if selectedProject === index}
                <div
                  class="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-border space-y-3 md:space-y-4 animate-slide-up"
                >
                  <div>
                    <h4
                      class="font-semibold text-xs md:text-sm uppercase tracking-wide text-primary mb-1 md:mb-2"
                    >
                      Problem
                    </h4>
                  ...
                  <div>
                    ...
                    <p
                      class="text-xs md:text-sm text-muted-foreground font-medium"
                    >
                      {project.results}
                    </p>
                  </div>
                  ...
                  <div class="bg-muted/50 p-3 md:p-4 rounded-lg">
                    <p class="text-xs md:text-sm italic mb-1 md:mb-2">
